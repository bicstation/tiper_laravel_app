                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-light p-3 rounded shadow-sm">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <i class="fas fa-file me-1"></i><?php the_title(); // WordPressの投稿タイトルを表示 ?>
                                </li>
                            </ol>
                        </nav>
                        <h1 class="mb-4"><i class="fas fa-clipboard-list me-2"></i><?php the_title(); // WordPressの投稿タイトルを表示 ?></h1>
                        <div class="entry-content">
                            <?php the_content(); // WordPressの投稿コンテンツを表示 ?>
                        </div>
                        <div class="row">
